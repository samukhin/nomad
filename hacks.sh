...
socat TCP-LISTEN:8080,fork,reuseaddr EXEC:"bash -e ./route_handler.sh 'nomad alloc exec -address https://..4646.com  -task example ee0b1fe6 socat - TCP4:localhost:22'"
